...
function smallMenu(tid,mNums)
	...
	case 3
		...
		tempStr = tempStr & "<li><a href=""news.asp"" {2}>信息中心管理</a></li>" & vbcrlf
		tempStr = tempStr & "<li><a href=""product.asp"" {3}>首页幻灯管理</a></li>" & vbcrlf
		tempStr = tempStr & "<li><a href=""mainProduct.asp"" {5}>作品欣赏管理</a></li>" & vbcrlf
		'tempStr = tempStr & "<li><a href=""range.asp"" {6}>练习场地管理</a></li>" & vbcrlf
		tempStr = tempStr & "<li><a href=""price.asp"" {7}>套餐报价管理</a></li>" & vbcrlf
