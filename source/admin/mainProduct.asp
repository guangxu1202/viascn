	...
	<div id="wrapper">
        ...
        <div id="containerHolder">
			<div id="container">
                ...
                <h2><a href="#">网站内容管理</a> &raquo; <a href="#" class="active">作品欣赏管理</a></h2>
                ...
                <div id="main">
					...
					<h3>作品欣赏列表</h3>
						...
						<h3><a name="add"></a>添加作品</h3>
                        <%else%>
                        <form action="<%=actstr%>" class="jNice" target="act" method="post">
						<h3>修改作品</h3>
                        <%end if%>
                    	<fieldset>
                        	<p><label>作品名称:</label><input type="text" name="ProName" value="<%=ProArrayValue(1)%>" class="text-long" /></p>
                            <p><label>作品类别:</label>
                            <%
                            ...
                            <p><label style="position:relative;">作品图片:
