...
title = "产品管理 - 欢迎登陆ESCMS网站内容管理系统"
'SortDiyField
ProArray = array("ProID","ProName","ProSort","ProsmallPic","ProBigPic","ProIsTop","ProIsReview","ProKeywords","Prodescription","ProContent","price")
...
elseif request.QueryString("act") = "plup" then
	...
	dbclose
	writealert "批量处理成功！","price.asp?page="&intpage&"&sortid="&sortid
...
elseif request.QueryString("act") = "ups" then
	...
	eRs.Close
	dbclose
	writealert "修改成功","price.asp?page="&intpage&"&sortid="&sortid
end if
	...
	<div id="wrapper">
        ...
        <div id="containerHolder">
			<div id="container">
                ...
                <h2><a href="#">网站内容管理</a> &raquo; <a href="#" class="active">套餐报价管理</a></h2>
                ...
                <div id="main">
					...
					<h3>套餐报价列表</h3>
                        ...
                        <%end if%>
                    	<fieldset>
                        	<p><label>套餐名称:</label><input type="text" name="ProName" value="<%=ProArrayValue(1)%>" class="text-long" /></p>
                            <p><label>所属类别:</label>
                            <%
							...
							<p><label>套餐价格:</label><input type="text" name="price" value="<%=ProArrayValue(10)%>" class="text-long" /></p>
                            ...
                            <div id="diyfield">
                             ...
                             <p><label>套餐简介:</label><textarea rows="1" name="Prodescription" cols="1"><%=ProArrayValue(8)%></textarea></p>
                            <p><label>套餐介绍:</label>
                            <%
                            ...
                            <button type="button" onclick="window.location='price.asp';"><span><span>返 回</span></span><div></div></button>
                            <%end if%>
                        </fieldset>
                    </form>
                </div>
